...
it('adds error message when BOOK_SLOTS_FAILURE action called', () => (
  expect(errors([], { type: 'BOOK_SLOTS_FAILURE', response: { errors: ['booking failure'] } })).toEqual(['booking failure'])
));
